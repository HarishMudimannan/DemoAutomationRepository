...
public class Datatable {
	...
	public int rowCount(String fileName,String sheetName)
	{
		...
		try
		{
			...
			System.out.println(sheetName+"  +++data table sheet name");
			if(sh==null)
			{
				return -1;
			}
			rc=sh.getPhysicalNumberOfRows();
			System.out.println("Row count in "+sheetName+" :"+rc);
		}catch(Exception e)
		{
			e.printStackTrace();
		}finally
	...
	/*public static void main(String a[])
	{
		...
		String file=path+"\\Controller\\data_Controller.xlsx";
		obj.importExcelFile(file);
		String val=obj.getCellData("Scenarios", "DOJ", 5);
