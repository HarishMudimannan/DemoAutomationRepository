...
public class ActiTimePage2 {
	...
	// click on Task 1
	@FindBy(xpath="//div[text()='TestTask']")
...
//	@FindBy(xpath="//*[@id='taskListBlock']/div[3]/div[4]/div/div[3]/div")  
//	private WebElement oselectAlltasktodelete1;
//	public WebElement getselectAlltasktodelete1()
//	{
//		return oselectAlltasktodelete;
//	}
	
	//deleteTasktoselect -- Action button
	...
	private WebElement taskPanel_deleteConfirm;
	public WebElement getconfirmDeleteTask()
	{
		return taskPanel_deleteConfirm;
	}
